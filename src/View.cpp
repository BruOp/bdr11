...
namespace bdr
{
    ...
    {
        view.type = View::CameraType;
        view.perspectiveProvider.camera = camera;
    }

    void setConstants(Renderer* renderer, const View& view)
    {
        ASSERT(view.type != View::Unknown, "Cannot set constants for unknown view");
        auto* context = renderer->getContext();
        if (view.type == View::CameraType) {
        ...
        else if (view.type == View::LightType) {
            // TODO;
        }
    }
}